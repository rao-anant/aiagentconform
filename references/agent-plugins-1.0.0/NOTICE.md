# Upstream schema attribution

The unchanged plugin.schema.json and mcp.schema.json files in
src/protocols/agent-plugins/schemas are from Agent Plugins 1.0.0:
...
checks; it does not redistribute the full specification text.
